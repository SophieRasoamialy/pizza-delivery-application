          ...
          <div className="flex items-center justify-between">
            ...
            {isAuthenticated ? (
                ...
                <div>
                    ...
                    <button type="button" className="relative inline-flex items-center justify-center mb-2 me-2 overflow-hidden text-sm font-medium text-red-700 rounded-full group bg-white hover:bg-red-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300">
                        <span className="relative px-5 py-2.5 transition-all ease-in duration-75 rounded-md group-hover:bg-opacity-0">
                            Sign In
                        </span>
                    </button>
